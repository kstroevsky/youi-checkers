...
- `2564928` (2026-07-19): Fix: Minor mutliplayer gameplay fixes:
- `adccc33` (2026-07-19): Fix multiplayer connection protocol
- `4da8242` (2026-07-18): Testing: Full-scale game quality measurement infrastructure update
- `859128a` (2026-07-17): Feature: Separate multi-game after-match moves calculation model
- `c79fbfb` (2026-07-17): Feature: Multi-jump visual latency

## Open pull requests
- [#1 Add Cloudflare Workers configuration](https://github.com/kstroevsky/youi-checkers/pull/1); branch `cloudflare/workers-autoconfig`; updated 2026-07-09T05:02:52Z

## Open GitHub issues
- None open at collection time.
...
## Known problems
See the open GitHub issues above; do not infer additional problems without evidence.
